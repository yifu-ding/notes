...
1. [[#[Q19] 什么是 RAG？|[Q19] 什么是 RAG？]]
2. [[#[Q20] RAG 有哪些代表性技术和工作？|[Q20] RAG 有哪些代表性技术和工作？]]
3. [[#[Q1] RAG 核心组件、RAG 系统中最关键的组件有哪些？整体架构是什么样的？|[Q1] RAG 核心组件、RAG 系统中最关键的组件有哪些？整体架构是什么样的？]]
4. [[#[Q2] 如果 Query 和 Context 匹配不好，可能有哪些原因？有哪些对策？|[Q2] 如果 Query 和 Context 匹配不好，可能有哪些原因？有哪些对策？]]
	1. [[#[Q2] 如果 Query 和 Context 匹配不好，可能有哪些原因？有哪些对策？#[Q2.1] 文档切分不好具体指什么？有哪些应对方式？|[Q2.1] 文档切分不好具体指什么？有哪些应对方式？]]
	2. [[#[Q2] 如果 Query 和 Context 匹配不好，可能有哪些原因？有哪些对策？#[Q2.2] Embedding 模型训得不好具体指什么？有哪些应对方式？|[Q2.2] Embedding 模型训得不好具体指什么？有哪些应对方式？]]
5. [[#[Q3] RAG 主要解决 LLM 的哪些问题？|[Q3] RAG 主要解决 LLM 的哪些问题？]]
6. [[#[Q4] 查询重写（Query Rewriting）指的是什么？有哪些常见做法？|[Q4] 查询重写（Query Rewriting）指的是什么？有哪些常见做法？]]
